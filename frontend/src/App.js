      ...
      <section id="problem" className="py-20 px-4 sm:px-6 lg:px-8" data-testid="problem-section">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 section-fade-in">
            <div className="gradient-border rounded-lg p-8 hover-lift" data-testid="problem-card-pollution">
              <div className="text-accent-blue text-4xl mb-4">🏭</div>
              <h3 className="text-2xl font-semibold mb-4">Urban Air Pollution Crisis</h3>
            ...
            <div className="gradient-border rounded-lg p-8 hover-lift" data-testid="problem-card-health">
              <div className="text-accent-teal text-4xl mb-4">⚕️</div>
              <h3 className="text-2xl font-semibold mb-4">Health Impact</h3>
              <p className="text-gray-300 leading-relaxed">
            ...
            <div className="gradient-border rounded-lg p-8 hover-lift" data-testid="problem-card-climate">
              <div className="text-accent-blue text-4xl mb-4">🌍</div>
              <h3 className="text-2xl font-semibold mb-4">Climate Change Acceleration</h3>
              <p className="text-gray-300 leading-relaxed">
            ...
            <div className="gradient-border rounded-lg p-8 hover-lift" data-testid="problem-card-existing">
              <div className="text-accent-teal text-4xl mb-4">⚙️</div>
              <h3 className="text-2xl font-semibold mb-4">Limitations of Existing Solutions</h3>
              <p className="text-gray-300 leading-relaxed">
